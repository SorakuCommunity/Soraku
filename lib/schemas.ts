...
export const profileSchema = z.object({
  display_name: z.string().min(1, 'Nama wajib diisi').max(50, 'Maks 50 karakter'),
  username: z
    .string()
    .min(3, 'Min 3 karakter')
    .max(30, 'Maks 30 karakter')
    .regex(/^[a-zA-Z0-9_]+$/, 'Hanya huruf, angka, underscore'),
  bio: z.string().max(200, 'Maks 200 karakter').nullable().optional(),
...
export const blogSchema = z.object({
  ...
  slug: z
    ...
    .regex(/^[a-z0-9-]+$/, 'Slug hanya boleh huruf kecil, angka, tanda hubung'),
