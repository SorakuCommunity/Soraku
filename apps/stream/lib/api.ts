...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || "https://apisoraku.vercel.app"
...
export const api = {
  ...
  anime: {
    ...
    episode: async (episodeId: string, source = "hianime", quality = "auto") => {
  ...
  watchHistory: {
    ...
    update: async (data: {
      ...
      return fetcher<ApiResponse<{ saved: boolean }>>("/api/stream/watch-history", {
        method: "POST",
