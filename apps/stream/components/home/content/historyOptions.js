            ...
            <Menu.Item>
              {({ active }) => (
                <button
                  ...
                  onClick={() => {
                    remove(watchId, aniId); // Ensure this calls the correct remove function
                  }}
                >
