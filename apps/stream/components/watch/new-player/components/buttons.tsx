    ...
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <GoogleCastButton className={buttonClass}>
          <ChromecastIcon className="w-8 h-8" />
        </GoogleCastButton>
      </Tooltip.Trigger>
      <Tooltip.Content
        offset={offset}
...
export function SkipOpButton({ tooltipPlacement, offset }: MediaButtonProps) {
  ...
  return (
    <button
      ...
      className="op-button hidden text-sm bg-secondary px-4 py-2 text-primary font-karla font-semibold rounded-md"
    >
      Skip Opening
    </button>
  );
...
export function SkipEdButton({ tooltipPlacement, offset }: MediaButtonProps) {
  ...
  return (
    <button
      ...
      className="ed-button hidden text-sm cursor-pointer bg-secondary px-4 py-2 text-primary font-karla font-semibold rounded-md"
    >
      Skip Ending
    </button>
  );
