              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-secondary p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2 flex flex-col flex-wrap gap-10">
                    <div className="space-y-1">
                      ...
                      <div className="space-y-2">
                        <div className="space-y-2">
                          <label className="text-gray-400 text-sm font-Archivo font-extrabold">
                            SCROLL
                          </label>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="space-y-2">
                        <label className="text-gray-400 text-sm font-Archivo font-extrabold uppercase">
                  ...
                  <div className="mt-4 text-right">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-transparent bg-purple-100 px-4 py-2 text-sm font-medium text-purple-900 hover:bg-purple-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
                      onClick={closeModal}
                    >
                      Got it, thanks!
                    </button>
