...
export default function Seasonal({ sessions }) {
  ...
  return (
    <Fragment>
      <Head>
        <title>1Anime - Trending This Season: Anime</title>
        <meta name="title" content="Trending This Season: Anime" />
        <meta
          name="description"
          content="Explore Trending This Season - Dive into the latest and most popular anime series on 1Anime. From thrilling action to heartwarming romance, discover the buzzworthy shows that have everyone talking. Stream now and stay up-to-date with the hottest anime trends!"
        />
      </Head>
      ...
      <main className="flex flex-col gap-2 items-center min-h-screen w-screen px-2 relative pb-10">
        <div className="z-50 bg-primary pt-3 pb-2 shadow-md shadow-primary w-full fixed px-2">
          <Link href="/" className="flex gap-2 items-center font-Archivo">
            ...
            <h1 className="text-lg">Trending This Season</h1>
          </Link>
        </div>
