...
export default function PopularAnime({ sessions }) {
  ...
  return (
    <Fragment>
      <Head>
        <title>1Anime - Popular Anime</title>
      ...
      <main className="flex flex-col gap-2 items-center min-h-screen w-screen px-2 relative pb-10 bg-primary">
        <div className="z-50 bg-secondary pt-3 pb-2 shadow-md shadow-primary w-full fixed px-3">
          <Link href="/" className="flex gap-2 items-center font-Archivo">
            <ChevronLeftIcon className="w-4 h-4" />
            <h1 className="text-lg">Popular Anime</h1>
          </Link>
        </div>
          ...
          {data?.map((i, index) => (
            ...
            >
              ...
              <Link
                ...
                title={i.title.romaji}
              >
                <h1 className="font-Archivo font-bold text-sm line-clamp-2">
                  {i.status === "RELEASING" ? (
