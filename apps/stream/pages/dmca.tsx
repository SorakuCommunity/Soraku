...
export default function DMCA() {
  return (
    <>
      <Head>
        <title>1Anime - DMCA</title>
        <meta name="DMCA" content="DMCA" />
        <meta property="og:title" content="DMCA" />
        <meta
          property="og:description"
          content="1Anime.co is committed to respecting the intellectual
      ...
      <Navbar withNav toTop shrink bgHover scrollP={110} paddingY={"py-1"} />
        <div className="min-h-screen z-20 flex w-screen justify-center items-center">
          <div className="px-5 lg:px-0 lg:w-[75%] text-2xl gap-7 flex flex-col my-[10rem]">
            <div className="flex">
              <h1 className="text-4xl font-bold font-Archivo rounded-md bg-secondary p-3">
                DMCA - Disclaimer
              </h1>
            </div>
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-3 text-[#cdcdcd]">
                <p>
                  1Anime.co is committed to respecting the intellectual
                  property rights of others and complying with the Digital
              ...
              <div className="text-xl ml-5 text-[#cdcdcd]">
                <ul className="flex flex-col gap-1">
                  ...
                  <li>· Please write to us in English.</li>
                </ul>
              </div>
              ...
              <h1 className="text-white font-Archivo">DISCLAIMER:</h1>
              <p className="text-[#cdcdcd]">
                None of the files listed on 1Anime.co are hosted on our
                servers. All links point to content hosted on third-party
                websites. 1Anime.co does not accept responsibility for content
                ...
                <a
                  href="mailto:contact@1Anime.co?subject=[1Anime]%20-%20Your%20Subject"
                  className="font-semibold"
                >
                  contact@1Anime.co
                </a>{" "}
                and while we cannot remove the sources, we will make them
                inaccessible.
              </p>
            </div>
          </div>
