  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-full max-w-screen-lg mx-5 mt-5 px-5 lg:px-0 lg:mt-14">
        {data && (
          <div className="flex lg:flex-row flex-col z-30 pt-24 lg:px-5">
            <div className="shrink-0 z-50 w-[170px] h-[240px] rounded overflow-hidden bg-secondary/20">
              {data?.image && (
                <Image
                  src={`https://seashell-app-wojsv.ondigitalocean.app/utils/image-proxy?url=${encodeURIComponent(
                    data?.image
            ...
            <div className="flex flex-col items-start justify-end gap-2 lg:pl-5 z-30 mt-5 lg:mt-0">
              <h1 className="font-bold text-2xl lg:text-3xl font-Archivo line-clamp-2">
                {data?.title}
              </h1>
              {/* <div className="flex gap-5 w-full">
                <p className="flex gap-2 font-bold font-Archivo">
              ...
              <p className="line-clamp-2 font-light font-Archivo">
                {data?.description}
              </p>
            </div>
          </div>
        ...
        <div className="mt-10">
          <input
            className="appearance-none rounded bg-secondary px-2 py-1 font-Archivo outline-none"
            placeholder="Search..."
            value={filter}
        ...
        <div className="mt-5 flex flex-col gap-3">
          {filteredData?.map((chapter: ChapterType) => (
            ...
            >
              <div className="flex justify-between items-center font-Archivo w-full">
                <div className="">
