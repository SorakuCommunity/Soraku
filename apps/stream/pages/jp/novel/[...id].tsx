          ...
          <div className="flex lg:flex-row flex-col z-30 pt-24 lg:px-5">
            ...
            <div className="flex flex-col items-start justify-end gap-2 lg:pl-5 z-30 mt-5 lg:mt-0">
              ...
              <div className="flex gap-5 w-full">
                ...
                <p className="flex-1 gap-2 font-bold font-Archivo overflow-x-hidden text-ellipsis whitespace-nowrap">
          ...
          {data?.chapters?.map((chapter) => (
            ...
            >
              <div className="flex justify-between w-full">
                <p className="font-bold font-Archivo">{chapter?.chapter}</p>
                <p className="font-light font-Archivo">{chapter?.release}</p>
              </div>
            </Link>
          ))}
        </div>
