      ...
      try {
        ...
        if (aniId && mangadexId) {
          ...
          if (mangadexId) {
            ...
            router.push("/manga/" + aniId + "/" + mangadexId, undefined, {
              shallow: true,
            });
          } else {
            ...
            setLoading(false);
            setNotFound(true);
            // router.push("/manga/" + aniId, undefined, { shallow: true });
          }
        } else if (!aniId && mangadexId) {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`${domainUrl}/manga/${metaData?.id}`}
        />
