...
export const SeabankIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
    ...
    />
    <path
      d="M8 14.5 Q10 18 12 18 Q14 18 16 14.5"
      stroke="white"
      strokeWidth="1.3"
      fill="none"
      strokeLinecap="round"
...
export const GopayIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
    ...
    {/* G letter */}
    <path
      d="M8.5 12 C8.5 9.5 10.5 7.5 13 7.5 C14.4 7.5 15.6 8.1 16.4 9.1 L14.8 10.3 C14.3 9.7 13.7 9.3 13 9.3 C11.5 9.3 10.3 10.5 10.3 12 C10.3 13.5 11.5 14.7 13 14.7 C14 14.7 14.8 14.2 15.3 13.4 L13.2 13.4 L13.2 11.7 L17.2 11.7 L17.2 12.2 C17.2 14.8 15.3 16.5 13 16.5 C10.5 16.5 8.5 14.5 8.5 12 Z"
      fill="white"
    />
  </svg>
)
...
export const SORAKU_SOCIALS: CustomIconEntry[] = [
  ...
  },
  {
    ...
    slug: 'linkedin',
    category: 'social',
    href: 'https://linkedin.com/company/soraku',
    icon: LinkedInIcon,
  },
  {
    name: 'Instagram',
...
export function getIconsByCategory(category: CustomIconEntry['category']): CustomIconEntry[] {
