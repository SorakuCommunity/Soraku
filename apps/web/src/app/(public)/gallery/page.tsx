...
function Lightbox({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative mx-16 flex max-h-[85vh] max-w-4xl flex-col items-center gap-4"
      ...
      >
        ...
        {/* Info bar */}
        <div className="flex w-full max-w-2xl items-start justify-between gap-4 px-1">
          <div className="min-w-0 flex-1">
            {item.title && <p className="truncate font-black text-white/90">{item.title}</p>}
            {item.description && (
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h3 className="mb-2 text-xl font-black">Karya Terkirim!</h3>
          <p className="text-muted-foreground/60 mb-6 text-sm">
            Sedang ditinjau admin. Akan muncul di galeri setelah disetujui.
          </p>
          <button
            onClick={onClose}
...
export default function GalleryPage() {
  ...
  useEffect(() => {
    fetchGallery(activeFilter, search, page)
