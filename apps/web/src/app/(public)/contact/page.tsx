  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      <div className="mb-12 text-center">
        <p className="text-primary/70 mb-3 text-xs font-bold tracking-widest uppercase">Hubungi Kami</p>
        ...
        <p className="text-muted-foreground/70 mx-auto mt-4 max-w-lg text-sm leading-relaxed">
          Kami ingin sekali mendengar kabar dari kalian! Ada pertanyaan, masukan, atau cuma mau
          say hi? Jangan ragu buat menghubungi kami lewat formulir di bawah ini. Kami senang
          banget kalau bisa ngobrol sama kalian dan pasti bakal berusaha buat bales secepatnya.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-[#D9DDE3]">Email</h3>
                <a href="mailto:admin@soraku.id"
                  className="text-primary/70 hover:text-primary text-sm transition-colors">
                  admin@soraku.id
                </a>
                <p className="text-muted-foreground/40 mt-1 text-xs">
                  Untuk pertanyaan bisnis, kerja sama, atau hal yang memerlukan respon formal.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#5865F2]/10 border border-[#5865F2]/20">
                <DiscordIcon className="h-5 w-5 text-[#5865F2]" />
              </div>
              <div>
                <h3 className="text-sm font-bold text-[#D9DDE3]">Discord Server</h3>
                <p className="text-muted-foreground/40 mt-1 text-xs mb-3">
      ...
      <div className="mt-10 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 sm:p-8">
        <h2 className="text-lg font-bold text-[#D9DDE3] mb-4">Info & Saran</h2>
        <div className="text-muted-foreground/60 space-y-4 text-sm leading-relaxed">
          <p>
            Kalau kalian punya request spesial, kayak update konten anime terbaru, rekomendasi
            game yang seru, atau tips buat nge-boost pengalaman main kalian, jangan malu-malu
            buat ngasih tahu! Kami selalu siap buat bikin konten yang kalian pengen dan kasih
            info paling up-to-date.
          </p>

          <div className="border-border/20 rounded-xl border bg-white/[0.02] p-4">
            <p className="text-amber-400/80 text-xs font-bold mb-2">Perhatian!</p>
