...
const SITEURL = "https://www.soraku.id";

const SOCIAL_LINKS = [
  { slug: "discord",   name: "Discord",   href: "https://discord.gg/qm3XJvRa6B",                Icon: DiscordIcon,   action: "Gabung Server", color: "hover:text-indigo-400",  accent: "group-hover:bg-indigo-500/8 group-hover:border-indigo-500/25" },
  { slug: "instagram", name: "Instagram", href: "https://www.instagram.com/soraku.moe",           Icon: InstagramIcon, action: "Follow",        color: "hover:text-pink-400",    accent: "group-hover:bg-pink-500/8 group-hover:border-pink-500/25"    },
  { slug: "facebook",  name: "Facebook",  href: "https://www.facebook.com/share/1HQs9ZZeCw/",     Icon: FacebookIcon,  action: "Like Page",     color: "hover:text-blue-400",    accent: "group-hover:bg-blue-500/8 group-hover:border-blue-500/25"    },
  { slug: "x",         name: "X",         href: "https://twitter.com/@AppSora",                  Icon: XIcon,         action: "Follow",        color: "hover:text-foreground",  accent: "group-hover:bg-white/4 group-hover:border-white/15"          },
  { slug: "tiktok",    name: "TikTok",    href: "https://www.tiktok.com/@soraku.id",              Icon: TikTokIcon,    action: "Follow",        color: "hover:text-pink-300",    accent: "group-hover:bg-pink-500/8 group-hover:border-pink-500/25"    },
  { slug: "youtube",   name: "YouTube",   href: "https://youtube.com/@chsoraku",                 Icon: YouTubeIcon,   action: "Subscribe",     color: "hover:text-red-400",     accent: "group-hover:bg-red-500/8 group-hover:border-red-500/25"      },
  { slug: "bluesky",   name: "Bluesky",   href: "https://bsky.app/profile/soraku.id",            Icon: BlueSkyIcon,   action: "Follow",        color: "hover:text-sky-400",     accent: "group-hover:bg-sky-500/8 group-hover:border-sky-500/25"      },
];
...
function Counter({ value, suffix = "" }: { value: string; suffix?: string }) {
  return <span className="tabular-nums font-black">{value}{suffix}</span>;
}
...
export default function HomePage() {
  ...
  return (
    <>
      {/* ══════════════════════════════════════════════
          HERO — Dramatic entrance, seamless bg
          ══════════════════════════════════════════════ */}
          ...
          <div className="grid gap-16 lg:grid-cols-[1fr_420px] lg:items-center lg:gap-24">
            ...
            <div className="order-2 lg:order-1 max-w-2xl">
              ...
              <div className="space-y-3 max-w-lg">
                ...
                <p className="text-sm leading-loose text-muted-foreground/60">
                  ...
                  Tempat berbagi karya, berdiskusi, mengikuti event, dan bertemu teman-teman yang sefrekuensi.
                </p>
                <p className="text-sm leading-loose text-muted-foreground/50">
            ...
            <div className="order-1 lg:order-2 flex justify-center">
              <div className="relative w-[260px] sm:w-[320px] lg:w-[360px]">
                ...
                {/* Float badges — apa itu soraku hints */}
                <div className="absolute -right-6 top-20 rounded-full border border-border/30 bg-background/70 px-3.5 py-1.5 text-[11px] font-semibold backdrop-blur-md float-badge shadow-sm">
                  🌸 Komunitas
                </div>
                <div className="absolute -left-8 top-36 rounded-full border border-border/30 bg-background/70 px-3.5 py-1.5 text-[11px] font-semibold backdrop-blur-md float-badge shadow-sm" style={{ animationDelay: "1s" }}>
                  🎌 Anime & Manga
                </div>
                <div className="absolute -right-4 bottom-36 rounded-full border border-border/30 bg-background/70 px-3.5 py-1.5 text-[11px] font-semibold backdrop-blur-md float-badge shadow-sm" style={{ animationDelay: "2s" }}>
                  ✨ Non-profit
                </div>
                <div className="absolute -left-6 bottom-24 rounded-full border border-border/30 bg-background/70 px-3.5 py-1.5 text-[11px] font-semibold backdrop-blur-md float-badge shadow-sm" style={{ animationDelay: "0.5s" }}>
                  🇮🇩 Indonesia
                </div>
              </div>
            </div>
      ...
      <section className="px-4 py-20 sm:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          {/* Discord banner — seamless gradient, no hard card */}
          <div className="relative">
            ...
            <div className="relative flex flex-col gap-8 sm:flex-row sm:items-center sm:gap-12">
              ...
              <div className="flex items-center gap-5">
                <div className="relative flex h-18 w-18 flex-shrink-0 items-center justify-center">
                  <div className="absolute inset-0 rounded-2xl bg-indigo-500/12 blur-lg" />
              ...
              {/* Divider */}
              <div className="hidden sm:block h-16 w-px bg-gradient-to-b from-transparent via-border/30 to-transparent" />
              ...
              <div className="flex items-center gap-8 flex-1">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground/45">online sekarang</p>
                </div>
                <div>
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-[11px] text-muted-foreground/45">total member</p>
                </div>
              </div>

              {/* CTA */}
              <a href="https://discord.gg/qm3XJvRa6B" target="_blank" rel="noopener noreferrer"
                className="group flex-shrink-0 inline-flex items-center gap-2.5 rounded-2xl border border-indigo-500/25 bg-indigo-500/10 px-6 py-3.5 text-sm font-bold text-indigo-300 transition-all duration-300 hover:-translate-y-0.5 hover:border-indigo-400/40 hover:bg-indigo-500/18 hover:text-indigo-200">
      ...
      {/* ══════════════════════════════════════════════
          EVENTS + BLOG — side by side, no cards
          ══════════════════════════════════════════════ */}
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <div>
              <div className="mb-8 flex items-end justify-between">
                ...
                <Link href="/events" className="group flex items-center gap-1.5 text-xs font-semibold text-muted-foreground/40 transition-colors hover:text-primary">
                  Semua event <ChevronRight className="h-3 w-3 transition-transform group-hover:translate-x-0.5" />
                </Link>
              </div>

              {/* Separator */}
              <div className="mb-6 h-px bg-gradient-to-r from-primary/20 via-border/30 to-transparent" />

              {loading ? (
                <div className="space-y-0">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="flex items-center gap-4 py-5 border-b border-border/15 last:border-0 animate-pulse">
                      <div className="h-14 w-20 rounded-xl bg-muted/15 flex-shrink-0" />
                ...
                <div className="py-16 text-center">
                  <Calendar className="mx-auto h-10 w-10 text-muted-foreground/10 mb-3" />
                  <p className="text-sm text-muted-foreground/30">Belum ada event</p>
                </div>
              ) : (
                <div>
                  {data.events.map(e => {
                    ...
                    return (
                      <Link key={e.id} href={`/events/${e.slug}`}
                        className="group flex items-center gap-4 py-4 border-b border-border/15 last:border-0 transition-colors hover:border-primary/15 -mx-3 px-3 rounded-xl">
                        <div className="relative h-14 w-20 flex-shrink-0 overflow-hidden rounded-xl bg-muted/15">
                          {e.coverurl
                            ? <Image src={e.coverurl} alt="" fill className="object-cover transition-transform duration-500 group-hover:scale-110" unoptimized />
                            : <div className="flex h-full items-center justify-center"><Calendar className="h-4 w-4 text-muted-foreground/20" /></div>
                          }
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="line-clamp-1 text-sm font-bold group-hover:text-primary transition-colors">{e.title}</p>
                          <p className="mt-0.5 text-xs text-muted-foreground/40">{fmtDate(e.startdate)}</p>
                        </div>
            ...
            <div>
              <div className="mb-8 flex items-end justify-between">
                ...
                <Link href="/blog" className="group flex items-center gap-1.5 text-xs font-semibold text-muted-foreground/40 transition-colors hover:text-primary">
                  Semua artikel <ChevronRight className="h-3 w-3 transition-transform group-hover:translate-x-0.5" />
                </Link>
              </div>
              ...
              {loading ? (
                <div className="space-y-0">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="flex items-start gap-4 py-5 border-b border-border/15 last:border-0 animate-pulse">
                      <div className="h-14 w-20 rounded-xl bg-muted/15 flex-shrink-0" />
                ...
                <div className="py-16 text-center">
                  <BookOpen className="mx-auto h-10 w-10 text-muted-foreground/10 mb-3" />
                  <p className="text-sm text-muted-foreground/30">Belum ada artikel</p>
                </div>
              ) : (
                <div>
                  {data.blogs.map(b => (
                    <Link key={b.id} href={`/blog/${b.slug}`}
                      className="group flex items-start gap-4 py-4 border-b border-border/15 last:border-0 transition-colors hover:border-primary/15 -mx-3 px-3 rounded-xl">
                      <div className="relative h-14 w-20 flex-shrink-0 overflow-hidden rounded-xl bg-muted/15">
                        {b.coverurl
                          ? <Image src={b.coverurl} alt="" fill className="object-cover transition-transform duration-500 group-hover:scale-110" unoptimized />
                          : <div className="flex h-full items-center justify-center"><BookOpen className="h-4 w-4 text-muted-foreground/20" /></div>
                        }
                      </div>
                      <div className="flex-1 min-w-0 pt-0.5">
                        ...
                        <div className="mt-1.5 flex items-center gap-3">
                          <span className="text-xs text-muted-foreground/35">{fmtDate(b.publishedat)}</span>
                          {(b.viewcount || b.likecount) && (
                            <span className="flex items-center gap-2 text-[10px] text-muted-foreground/30">
      ...
      {/* ══════════════════════════════════════════════
          SOSIAL MEDIA — grid layout
          ══════════════════════════════════════════════ */}
      <section className="px-4 py-20 sm:py-24 border-t border-border/15">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex items-center gap-4">
            <div>
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7">
            {SOCIAL_LINKS.map(({ slug, name, href, Icon, action, color, accent }) => (
              <a key={slug} href={href} target="_blank" rel="noopener noreferrer"
                className={cn(
                  "group flex flex-col items-center justify-center gap-3 rounded-2xl border border-border/20 bg-transparent px-4 py-6 text-center transition-all duration-300 hover:-translate-y-1",
                  accent
                )}>
                <Icon className={cn("h-5 w-5 text-muted-foreground/40 transition-colors duration-300", color)} />
                <div>
                  <p className="text-xs font-bold text-foreground/70 transition-colors group-hover:text-foreground">{name}</p>
                  <p className="mt-0.5 text-[9px] text-muted-foreground/35">{action}</p>
                </div>
              </a>
            ))}
          </div>
      ...
      {/* ══════════════════════════════════════════════
          PARTNERSHIP / SPONSOR — hanya jika ada data
          ══════════════════════════════════════════════ */}
      {data.partnerships.length > 0 && (
        <section className="px-4 pb-20 sm:pb-24 border-t border-border/15 pt-20">
          <div className="mx-auto max-w-7xl">
            <div className="mb-10 text-center">
              <p className="text-[9px] font-black uppercase tracking-[0.25em] text-muted-foreground/30 mb-2">Kolaborasi</p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8">
              {data.partnerships.map(p => (
                <a key={p.id} href={p.website ?? "#"} target={p.website ? "_blank" : undefined} rel="noopener noreferrer"
                  className="group flex flex-col items-center gap-2.5 rounded-2xl px-5 py-4 transition-all duration-300 hover:bg-primary/4 w-24 sm:w-28">
                  <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-xl bg-muted/15 border border-border/25 transition-colors group-hover:border-primary/25">
                    {p.logourl
                  ...
                  <div className="text-center">
                    <p className="text-[10px] font-bold text-foreground/60 group-hover:text-primary transition-colors">{p.name}</p>
                    {p.category && <p className="text-[8px] text-muted-foreground/30 mt-0.5">{p.category}</p>}
                  </div>
                </a>
              ))}
            </div>
        ...
        <section className="relative px-4 pb-28 pt-20 overflow-hidden border-t border-border/15">
          ...
          <div className="mx-auto max-w-xl text-center">
            ...
            <h2 className="text-3xl font-black tracking-tight sm:text-4xl">
              Jadilah bagian dari{" "}
              <span className="text-primary">Soraku</span>
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground/60 max-w-sm mx-auto">
            ...
            <div className="my-8 flex items-center gap-4 max-w-xs mx-auto">
              ...
              <span className="text-xs text-muted-foreground/25 font-semibold">bergabung sekarang</span>
              <div className="flex-1 h-px bg-gradient-to-l from-transparent to-border/30" />
            </div>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link href="/register"
                className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl bg-primary px-8 py-3.5 text-sm font-bold text-white shadow-xl shadow-primary/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-primary/30">
                Daftar Gratis
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
              </Link>
              <Link href="/about"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl border border-border/30 px-8 py-3.5 text-sm font-semibold text-muted-foreground/70 transition-all hover:border-primary/25 hover:text-foreground">
                Tentang Soraku
              </Link>
            </div>
          </div>
