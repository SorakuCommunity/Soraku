    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="text-muted-foreground/80 space-y-8 text-sm leading-relaxed">
        <section>
          ...
          <p>
            Selamat datang di Soraku Community (&ldquo;Soraku&rdquo;, &ldquo;kami&rdquo;). Dengan
            mengakses atau menggunakan platform di{' '}
            <span className="text-foreground font-semibold">www.soraku.id</span>, kamu
            (&ldquo;pengguna&rdquo;) menyetujui Ketentuan Penggunaan ini. Jika tidak setuju dengan
            ketentuan apa pun, mohon hentikan penggunaan platform.
          </p>
          <p className="mt-2">
            Ketentuan ini berlaku untuk semua pengguna, termasuk pengunjung, anggota terdaftar,
            kreator, dan admin.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Soraku adalah platform komunitas non-profit yang berfokus pada budaya pop Jepang &mdash;
            anime, manga, VTuber, gaming, J-Music, dan cosplay. Platform menyediakan:
          </p>
        ...
        <section>
          ...
          <ul className="ml-2 list-inside list-disc space-y-1">
            <li>
              Bersikap sopan, saling menghormati, dan menjaga lingkungan komunitas yang positif.
            </li>
            <li>
              Tidak melakukan diskriminasi, perundungan (bullying), atau pelecehan dalam bentuk apa
              pun.
            </li>
        ...
        <section>
          ...
          <p className="mt-2">
            Pelanggaran dapat mengakibatkan peringatan, penangguhan sementara, atau penghapusan akun
            permanen.
          </p>
        </section>
        ...
        <section>
          ...
          <h3 className="text-foreground mt-4 mb-1 font-bold">a. Konten Platform</h3>
          <p>
            Seluruh elemen original platform Soraku &mdash; termasuk desain antarmuka, kode sumber,
            logo, maskot, dan dokumentasi &mdash; dilindungi hak cipta &copy; 2023&ndash;2026 Soraku
            Community. Penggunaan di luar platform tanpa izin tertulis dilarang.
          </p>

          <h3 className="text-foreground mt-4 mb-1 font-bold">b. Konten Pengguna</h3>
          <p>
            Konten yang kamu unggah (artikel, fanart, cosplay, komentar) tetap menjadi milikmu.
            Dengan mengunggah konten, kamu memberikan Soraku lisensi non-eksklusif untuk
            menampilkan, menyimpan, dan mendistribusikan konten tersebut di dalam platform.
          </p>

          <h3 className="text-foreground mt-4 mb-1 font-bold">c. Konten Pihak Ketiga</h3>
          <p>
            Karakter anime, manga, game, dan materi terkait yang ditampilkan di platform adalah
            milik pemegang hak cipta masing-masing. Soraku adalah komunitas non-komersial dan tidak
            mengklaim kepemilikan atas konten tersebut. Pengguna bertanggung jawab atas konten yang
            diunggah.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="ml-2 list-inside list-disc space-y-1">
            <li>
              Pendaftaran event mengikuti syarat yang ditetapkan pada halaman event masing-masing.
            </li>
            <li>
              Event berbayar memiliki ketentuan pembayaran dan kebijakan pengembalian yang terpisah.
            </li>
            <li>
              Soraku berhak membatalkan atau mengubah jadwal event tanpa pemberitahuan sebelumnya.
            </li>
        ...
        <section>
          ...
          <p>
            Platform Soraku disediakan &ldquo;sebagaimana adanya&rdquo; tanpa jaminan apa pun. Kami
            tidak bertanggung jawab atas:
          </p>
          <ul className="mt-2 ml-2 list-inside list-disc space-y-1">
            <li>
              Gangguan layanan, kehilangan data, atau kerusakan yang timbul dari penggunaan
              platform.
            </li>
        ...
        <section>
          <h2 className="text-foreground mb-3 text-lg font-black">
            9. Penangguhan dan Penghapusan Akun
          </h2>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            platform. Penggunaan berkelanjutan setelah perubahan dianggap sebagai persetujuan
        ...
        <section>
          ...
          <p>Untuk pertanyaan terkait Ketentuan Penggunaan:</p>
          <ul className="mt-2 ml-2 list-inside list-disc space-y-1">
            <li>
              Email: <span className="text-foreground font-medium">contact@soraku.id</span>
            </li>
            <li>
        ...
        <div className="mt-8 border-t border-white/[0.06] pt-6">
          <p className="text-muted-foreground/40 text-xs">
            Ketentuan Penggunaan ini berlaku untuk seluruh layanan Soraku Community. &copy;
            2023&ndash;2026 Soraku Community. Seluruh hak dilindungi.
          </p>
        </div>
      </div>
    </div>
