        ...
        <div className="flex h-14 items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="group flex items-center gap-2">
              ...
              <span className="text-sm font-black text-[#D9DDE3] transition-colors group-hover:text-[#4FA3D1]">
                Soraku
              </span>
            </Link>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/"
              className="hidden items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs text-[#6E8FA6] transition-colors hover:bg-white/5 hover:text-[#D9DDE3] sm:flex"
            >
            ...
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg border border-white/10 bg-[#4FA3D1]/10">
                {user?.avatarurl ? (
                  <Image
                    src={user.avatarurl}
                    alt={displayName}
              ...
              <button
                ...
                className="hidden text-[#6E8FA6]/60 transition-colors hover:text-red-400 sm:block"
              >
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg text-[#6E8FA6] transition-colors hover:bg-white/5 hover:text-[#D9DDE3] lg:hidden"
            >
      ...
      <div className="mx-auto flex max-w-7xl gap-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="sticky top-20 space-y-4">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-white/[0.06] bg-white/[0.03] p-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-[10px] text-[#6E8FA6]/60">Soraku Panel</p>
              </div>
            </div>

            {/* Nav */}
            <nav className="space-y-0.5 rounded-xl border border-white/[0.06] bg-white/[0.02] p-2">
              {(() => {
                ...
                return ADMIN_NAV.map(({ href, label, icon: Icon, group }) => {
                  ...
                  return (
                    <div key={href}>
                      {showGroup && group && (
                        <p className="mt-3 mb-1.5 px-2 text-[9px] font-black tracking-[0.2em] text-[#6E8FA6]/40 uppercase">
                          {group}
                        </p>
                      )}
                      <Link
                        ...
                        <span className="flex items-center gap-2.5">
                          <Icon
                            className={cn(
                              ...
                              active ? 'text-[#4FA3D1]' : 'text-[#6E8FA6]/50'
                            )}
                          />
                          {label}
                        </span>
            ...
            <p className="px-2 text-[9px] font-semibold tracking-wider text-[#6E8FA6]/30 uppercase">
              Soraku v1.0
            </p>
          </div>
        </aside>
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            />
            <div className="absolute top-14 bottom-0 left-0 w-64 overflow-y-auto border-r border-white/[0.06] bg-[#1C1E22] p-4">
              <nav className="space-y-0.5">
                ...
                <Link
                  href="/"
                  className="flex items-center gap-2.5 rounded-lg px-3 py-2.5 text-sm text-[#6E8FA6]/70 hover:bg-white/5 hover:text-[#D9DDE3]"
                >
                  <ArrowLeft className="h-4 w-4" /> Kembali ke Situs
                </Link>
                <button
                  onClick={handleSignout}
                  className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2.5 text-sm text-red-400/60 transition-colors hover:bg-red-500/5 hover:text-red-400"
                >
