    ...
    <div className="w-full max-w-md">
      <div className="rounded-2xl border p-8" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border)' }}>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" value={username} onChange={e => setUsername(e.target.value)}
                placeholder="username_kamu" required minLength={3} maxLength={30}
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--text-sub)' }}>
          Sudah punya akun?{' '}
          <Link href="/login" className="font-medium hover:underline" style={{ color: 'var(--color-primary)' }}>Masuk di sini</Link>
        </p>
      </div>
    </div>
    </div>
