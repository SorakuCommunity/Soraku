// app/page.tsx — SORAKU v1.0.a3.2
'use client'
import Link from 'next/link'
import { motion } from 'framer-motion'
import { Images, MessageCircle, Calendar, Image as ImageIcon } from 'lucide-react'
  ...
  <Link
    ...
    className={`
      ...
      ${variant === 'outline'
        ...
        : variant === 'ghost'
          ? 'bg-transparent hover:bg-secondary/10 shadow-none'
    ...
    >
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-primary/10 px-5 py-2 rounded-full mb-8 w-fit mx-auto border border-primary/20">
              ...
              <span className="text-sm font-semibold text-primary">Komunitas Aktif</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button href="https://discord.gg/CJJ7KEJMbg" className="h-14 text-lg px-10 shadow-xl">
                Join Discord
              </Button>
              <Button href="/gallery" variant="outline" className="h-14 text-lg px-10">
                View Gallery
              </Button>
            </div>
          </motion.div>
            ...
            {[
              ...
              >
                <Card className="h-full">
                  ...
                  <Button href="/events" variant="ghost" className="w-full h-12 px-4">
                    View Details →
                  </Button>
                </Card>
              </motion.div>
      ...
      <section className="py-24 bg-secondary/10">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            <Button href="/gallery" className="h-14 px-12 text-lg shadow-xl">
      ...
      <section className="py-24 border-t">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          >
            <Button href="https://discord.gg/CJJ7KEJMbg" className="h-16 px-16 text-xl font-bold shadow-2xl">
