...
const ENDPOINTS = [
  ...
  { method: "GET", path: "/api/users/:username", desc: "Profil publik user" },
  {
    ...
    desc: "Update profil (auth)",
  },
  { method: "GET", path: "/api/premium", desc: "Status subscriber user login" },
  {
    method: "GET",
    path: "/api/premium?leaderboard=true",
    desc: "Top donatur publik",
  },
  ...
  {
    method: "GET",
    path: "/api/stream?anime=true&q=:q",
    desc: "Cari anime (GogoAnime, HiAnime, Animekai, AniBaru)",
  },
  {
    method: "GET",
    path: "/api/stream/:slug",
    desc: "Detail stream / episode HLS",
  },
  {
    method: "GET",
    path: "/api/stream/sources",
    desc: "Status provider anime (online/offline)",
  },
  {
    method: "POST",
    path: "/api/donate/xendit/create",
    desc: "Buat invoice donasi (Xendit)",
  },
  {
    method: "POST",
    path: "/api/donate/xendit/webhook",
    desc: "Webhook konfirmasi Xendit",
  },
  {
    method: "POST",
    path: "/api/donate/trakteer",
    desc: "Webhook donasi Trakteer",
  },
];
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: "#7c3aed" }}>
            v{API_VERSION} · Central REST API
          </div>
        </div>

        {/* Navbar */}
        <nav style={{ marginLeft: 48, display: "flex", gap: 4 }}>
          {[
            { label: "Beranda", href: "/", active: true },
            { label: "API Reference", href: "/api", active: false },
            {
              label: "Dokumentasi",
              href: "https://docs.soraku.id",
              active: false,
              external: true,
            },
            {
              label: "Stream API Docs",
              href: "https://stream.soraku.id/api-docs",
              active: false,
              external: true,
            },
          ].map((link) => (
        ...
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h1
            style={{
              ...
              margin: "0 0 16px",
              background:
                "linear-gradient(135deg, #fff 30%, #a78bfa 70%, #60a5fa)",
            ...
            {[
              {
                icon: "🌐",
                label: "Web Komunitas",
                sub: "apps/web · Next.js",
                color: "#7c3aed",
              },
              {
                icon: "🎬",
                label: "Web Streaming",
                sub: "apps/stream · Next.js",
                color: "#3b82f6",
              },
              {
                icon: "📱",
                label: "Mobile App",
                sub: "apps/mobile · Expo",
                color: "#22c55e",
              },
              {
                icon: "🤖",
                label: "Discord Bot",
                sub: "services/bot · Railway",
                color: "#f59e0b",
              },
            ].map((c) => (
              <div
