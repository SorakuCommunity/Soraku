...
export default {
  ...
  async execute({ client, message, args }) {
    const ticketData = await db.getTicket(message.channel.id);
    ...
    const panel = await db.getTicketPanel(message.guild.id, ticketData.panel_id);
    ...
    await db.claimTicket(message.channel.id, message.author.id);
