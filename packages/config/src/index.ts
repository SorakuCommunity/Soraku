...
export const SORAKU_URLS = {
  ...
  stream: process.env.NEXT_PUBLIC_STREAM_URL ?? "https://stream.soraku.vercel.app",
  api: process.env.API_URL ?? "https://apisoraku.vercel.app",
...
export const USER_ROLES = ["OWNER", "MANAGER", "ADMIN", "AGENSI", "KREATOR", "USER"] as const
